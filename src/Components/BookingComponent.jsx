...
const BookingComponent = ({currentUser}) => {
  ...
  return (
    <div className="booking-container">
      ...
      <button className="book-bikes-button" onClick={handleFilterBikes}>
        Book Ride
      </button>

      

      <div className="filtered-bikes">
        {filteredBikes.length > 0 ? (
          ...
          <p>No available rides for the selected dates.</p>
        ) : success != "" ? (
          <p>{success}</p>
        ) : error != "" ? (
